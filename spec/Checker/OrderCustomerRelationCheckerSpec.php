...
{
    public function it_implements_order_customer_relation_checker_interface(): void
    {
        $this->shouldImplement(OrderCustomerRelationCheckerInterface::class);
    }

    public function it_returns_true_when_order_was_placed_by_customer(
    ...
    public function it_returns_false_when_order_was_not_placed_by_customer(
        CustomerInterface $orderCustomer,
        CustomerInterface $customer,
        OrderInterface $order,
    ): void {
    ...
    public function it_returns_false_when_order_has_no_customer_assigned(
        CustomerInterface $customer,
        OrderInterface $order,
    ): void {
